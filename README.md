...
## Preview
A project screenshot is available in `Screenshot.png` for quick reference.

## Credits
- Original track: "Khoune" by Sogand
- Remake / cover production project in FL Studio

این پروژه یک نسخه‌ی ریمیکس/کاور از آهنگ «Khoune» اثر Sogand در FL Studio است.
